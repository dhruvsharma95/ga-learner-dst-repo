...
print(secret_msg_1)
#print(type(message_1)) --> 'str'
#print(type(message_2)) --> 'str'
#print(type(secret_msg_1)) --> 'str'
...
def compare_msg(message_d,message_e):
    ...
    # print(a_list) --> List of words in a_list
    
    #Splitting the message into a list
    b_list = message_e.split()
    # print(b_list) --> List of words in b_list
...
def extract_msg(message_f):
    ...
    #print(b_list) --> gives list of words which have even alphabets
